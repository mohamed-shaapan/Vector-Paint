...
import polygonShapes.JSquare;

public class JCircle extends JOval{

	//***********************************************************************
	public JCircle(SimpleDoubleProperty[] observableBindingPoints, StrokeProperties strokeProperties,
	...
	public JPolygon setEnclosureShape(SimpleDoubleProperty[] observableBindingPoints) {
		...
		return new JSquare(observableBindingPoints, enclosureStroke, null);
	}
